...
export default function About() {
  return (
    <PageShell
      eyebrow="HISTORIEN"
      title="Om meg"
      subtitle="Utvikler på dagtid, håndverker på fritiden — med kjærlighet for godt design."
    >
      <Box
        display="flex"
      ...
      >
        <Typography variant="body1" maxWidth={700} textAlign="left" mb={4}>
          ...
          konsepter. Under navnet Vatsii_designs deler jeg glimt fra prosjekter
          jeg har jobbet med – blant annet restaureringen av trebåten Klasken og
          ulike møbel- og skiltprosjekter. Det er prosjekter som gir meg
          muligheten til å utforske kreativitet og stadig lære noe nytt.
          <br />
          <br />
          ...
          håndverk gir meg et unikt perspektiv. Med denne bakgrunnen håper jeg å
          skape helhetlige løsninger som forener det beste fra både digitale og
          fysiske verdener – alltid med brukeren i fokus.
        </Typography>
